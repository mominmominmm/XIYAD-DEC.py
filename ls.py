#JXB FUCKED BY SSG
#OKAT APNI PTA HO 
#TO HAWABAZI NHI KRTE BETA
#LKING KI COPY KRTA BSRKA‚
#BATAIN SUNNY LEON 
#K MAMMAY JITNI BARI
#-----------LUN MODULES-----------
from os import path
...
\033[1;32m----------------------------------------------
 ...
 \033[1;32m----------------------------------------------
 \033[1;37mME EK YATEEM HUN PEHLE ME SSG KA TATTA THA
    AJ ME HR BARAY LUN K UPAR BETH RHA HUN
\033[1;32m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        try:
                clear()
                os.system(' xdg-open https://www.facebook.com/100046762278279/posts/pfbid04LomQCqbnmiK9dbDAwwatFK4aMbTfJW3bB8jo7i337BDs2aDvHE4ihivirL8FGf7l/?app=fbl')
                if 1==1:
                        clear()
                        print('\033[1;37m[1] File cloning\n\033[1;37m[2] VISIT AWAIS TATTE KI OKAT\n\033[1;37m[0] Exit')
                        linex()
                        xd=input('\033[1;37m[?] Choice : ')
                        if xd in ['1','01']:
                                os.system(' xdg-open https://www.facebook.com/100046762278279/posts/pfbid04LomQCqbnmiK9dbDAwwatFK4aMbTfJW3bB8jo7i337BDs2aDvHE4ihivirL8FGf7l/?app=fbl');clear()
                                ...
                                os.system(' xdg-open https://www.facebook.com/100046762278279/posts/pfbid04LomQCqbnmiK9dbDAwwatFK4aMbTfJW3bB8jo7i337BDs2aDvHE4ihivirL8FGf7l/?app=fbl');menu()
                        elif xd in ['3','03']:
                                exit('BYE BYE JXB FUCKED BY SSG') 
                        elif xd in ['4','04']:
                                clear()
